 ...
 * @author ACER
 */
public class DecToBinForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Konversi Desimal ke Biner");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String adder="";
        String biner = Integer.toBinaryString(Integer.parseInt(input)); 
        if (biner.length() < 4) {
            switch (biner.length()) {
                case 1 -> adder = "000";
                case 2 -> adder = "00";
        ...
        outputText.setText(adder+biner);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecToBinForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
