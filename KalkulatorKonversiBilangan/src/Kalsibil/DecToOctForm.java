 ...
 * @author ACER
 */
public class DecToOctForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Konversi Desimal ke Oktal");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String oktal = Integer.toOctalString(Integer.parseInt(input));
        outputText.setText(oktal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecToOctForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
